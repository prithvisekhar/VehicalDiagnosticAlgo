...
potholeTrainImages = glob.glob("New_dataset/train/Pothole/*.jpg")
...
# nonPotholeTrainImages = glob.glob("New_dataset/train/Plain/*.png")
...
# nonPotholeTestImages = glob.glob("New_dataset/test/Plain/*.png")
nonPotholeTestImages = glob.glob("My Dataset/test/Plain/*.jpg")
nonPotholeTrainImages.extend(glob.glob("My Dataset/test/Plain/*.jpeg"))
nonPotholeTrainImages.extend(glob.glob("My Dataset/test/Plain/*.png"))
...
# potholeTestImages = glob.glob("New_dataset/test/Pothole/*.jpg")
potholeTestImages = glob.glob("My Dataset/test/Pothole/*.jpg")
nonPotholeTrainImages.extend(glob.glob("My Dataset/test/Pothole/*.jpeg"))
nonPotholeTrainImages.extend(glob.glob("My Dataset/test/Pothole/*.png"))
