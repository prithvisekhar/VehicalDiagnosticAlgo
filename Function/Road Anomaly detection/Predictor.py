...
size = 100
model = Sequential()
"""model = load_model('D:/G Drive backup/LTTS Internship/Reimplementing_codes/'
                   'Pothole detection/pothole-detection-system-using-CNN-master'
                   '/sample1.h5') """

model = load_model('sample1.h5')
# X_test = np.load('./models/trainData/128x72x3x10000/X_test.npy')
# y_test = np.load('./models/trainData/128x72x3x10000/y_test.npy')

# load Testing data : non-pothole
# nonPotholeTestImages = glob.glob("Images/No_pothole/*.bmp")
...
potholeTestImages = glob.glob("My Dataset/test/Pothole_1/*.jpg")
# potholeTestImages = glob.glob("D:/G Drive backup/LTTS Internship/Reimplementing_codes/Presentation/Pothole_images/*.jpg")
# nonPotholeTrainImages.extend(glob.glob("My Dataset/train/Plain/*.jpeg"))
# nonPotholeTrainImages.extend(glob.glob("My Dataset/train/Plain/*.png"))
